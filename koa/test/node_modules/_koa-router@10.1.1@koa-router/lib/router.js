  ...
  function setMethodVerb(method) {
    Router.prototype[method] = function(name, path, middleware) {
      if (typeof path === "string" || path instanceof RegExp) {
        middleware = Array.prototype.slice.call(arguments, 2);  // 如果有path，则middleware是第三个参数
      } else {
        middleware = Array.prototype.slice.call(arguments, 1);  // 否则middleware是第二个参数
        path = name;
        name = null;
      }
...
Router.prototype.routes = Router.prototype.middleware = function () {
  ...
  let dispatch = function dispatch(ctx, next) {
    ...
    layerChain = matchedLayers.reduce(function(memo, layer) { // reducer函数的参数：累计器，当前值
      memo.push(function(ctx, next) { // 对matchLayers数组中的每个layer，执行同样的操作，最终得到memo数组
